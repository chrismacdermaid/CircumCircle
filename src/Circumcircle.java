...
public class Circumcircle {
	...
	public Circumcircle(String Radius, String Thickness, String Angle, String email,int numberOfProteins,Vector<String> namesOfProteins) throws IOException
	{
	...
	public Circumcircle(String Radius, String Thickness, String Angle, String email,int numberOfProteins,Vector<String> namesOfProteins, String str) throws IOException
	{
		if(!Radius.startsWith("auto"))
		{
			this.radius = Float.parseFloat(Radius);
	...
	void draw3DMembrane()
	{
		...
		for(int i=0; Feta <= convertDegToRad(angle);Feta+=feta)
		{
			...
			{
				fmt1.format("HETATM%5d  N   DUM  %4d    %8.3f%8.3f%8.3f\n", i, 9999, (float)insideRadius*Math.sin(Feta)*Math.cos(Teta),(float)insideRadius*Math.sin(Feta)*Math.sin(Teta), (float)insideRadius*Math.cos(Feta));
				fmt1.format("HETATM%5d  O   DUM  %4d    %8.3f%8.3f%8.3f\n", i, 9998, (float)outsideRadius*Math.sin(Feta)*Math.cos(Teta),(float)outsideRadius*Math.sin(Feta)*Math.sin(Teta), (float)outsideRadius*Math.cos(Feta));
			}
		}
		fmt1.close();
	}
